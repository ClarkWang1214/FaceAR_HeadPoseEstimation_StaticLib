              ...
              render::Mesh &mesh, std::string &obj_root)
{
    ...
    // Save the mesh as textured obj:
    //outputfile += fs::path(".obj");
    render::write_textured_obj(mesh, obj_root + ".obj" /*strOBJ.str().append((string)".obj")*//*outputfile.string()*/);

    // And save the isomap:
    //outputfile.replace_extension(".isomap.png");
    cv::imwrite(obj_root+".isomap.png" /*(string)"result/" + *//*strOBJ.str().append((string)".isomap.png")*//*outputfile.string()*/, isomap);
